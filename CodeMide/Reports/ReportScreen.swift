...
//                                           y: .value("Value", point.y),
//                                           series: .value("Band", point.bandtype)
//                                       )
//                                       .foregroundStyle(
//                                           by: .value(
//                                               "Band",
...
//                                                           x: .value(
//                                                               "Time",
//                                                               question.eeg.time[index]
//                                                           ),
//                                                           y: .value(
//                                                               "Delta",
//                                                               question.eeg.delta[index]
//                                                           ),
//                                                           series: .value(
//                                                               "Band",
//                                                               "Delta"
